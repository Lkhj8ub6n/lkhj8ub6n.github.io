function voidcommits(response) {
	...
	for(i = 0; i < response.data.length; i++) {
		...
		html += '<tr>'+
				...
				'    <td class="pkg-arch">'+
				'        <a href="https://github.com/void-linux/void-projects/blob/master/srcpkgs/'+esc(commit.commit.message.split(':')[0])+'" title="Details for '+esc(commit.commit.message.split(':')[0])+'">any</a>'+
				'    </td>'+
				'</tr>';
